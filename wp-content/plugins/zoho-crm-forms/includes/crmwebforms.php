			...
			<table class='listview w100per'><thead>
				...
				<tr class='crmforms-crm-highlight crmforms-crm-alt border_ddd' >
                    ...
                    foreach ($shortcodemanager as $shortcode_fields) {
                        ...
                        $htmlcontent1 .= "<a href='#' class='edit_link dIB' onclick='edit_forms(\"Editshortcode\" , \"$shortcode_fields->module\" , \"$shortcode_fields->shortcode_name\",\"$activatedplugin\",\"$shortcode_fields->Layout_Name\")'> <sapn class='edit-icon dB'></span> </a>";
                        $htmlcontent1 .= "<a href='#' class='delete_link dIB' style='margin-left:2px;' onclick='deleteforms(\"zcfDeleteShortcode\" , \"$shortcode_fields->module\" , \"$shortcode_fields->shortcode_name\",\"$activatedplugin\",\"\",\"$shortcode_fields->form_name\")'>  <sapn class='delete-icon dB'></span> </a>";
                        $htmlcontent1 .= "</td>";
