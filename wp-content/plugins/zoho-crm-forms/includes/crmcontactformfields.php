                ...
                <div>
                    ...
                    <div style="max-height:500px;overflow:auto;">
                        <form>
                            ...
                            <?php
                                 $query_layout = "select layoutID from zcf_zohocrm_moduleLists where modulename='".$cform_module."' and Layoutname='".$_REQUEST['layoutname']."'";
                                $get_layoutjson_array = $wpdb->get_results($query_layout);
                                $layoutIDarray = $get_layoutjson_array[0]->layoutID;
                            ?>
                            <input type="hidden" name="layoutId" id="layoutId" value=<?php echo $layoutIDarray; ?>>
